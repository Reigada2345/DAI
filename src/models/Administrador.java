...
public class Administrador extends Cliente {
    ...
    public Administrador(String nomeProprio, String apelido, String contacto, 
    ...
    public String getNome() {
        return getNomeProprio() + " " + getApelido();  
    }
    ...
    public void editarParagem(Paragem paragem, String novoNome, String novaLocalizacao, 
                            boolean novasRotas, int novaLotacao) {
    ...
    public void editarAutocarro(Autocarro autocarro, String novoNumero, 
                              int novaCapacidade, String novaRota) {
        autocarro.editarAutocarro(novoNumero, novaCapacidade, novaRota);
    }

    public void atualizarPassageiro(Passageiro passageiro, String novoNome, 
                                  int novaIdade, String novoBilhete) {
